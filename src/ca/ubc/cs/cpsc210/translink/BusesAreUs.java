...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    public static final String TRANSLINK_API_KEY = "lxZISO5dwE0GgWOYl1fL";
    ...
    public void onLocationChanged(Stop nearest, LatLon locn) {
        ...
        if (nearest == null){
            nearestStopLabel.setText("No bus around yooou!");
        } else {
            myNearestStop = nearest;
            nearestStopLabel.setText("Nearest: " + myNearestStop.getName());
        }
    ...
    public void onStopSelected(Stop stop) {
        try {
            ...
            System.out.println("Stop exception was thrown");
        }
